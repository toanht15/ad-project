...
class RenameAdAccountIdToMediaAccountIdInFacebookAdsInsightsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('facebook_ads_insights', function ($table) {
            $table->dropForeign(['ad_account_id']);
            $table->dropIndex('facebook_ads_insights_ad_account_id_foreign');
