...
class RenameAdAccountIdToMediaAccountIdInFacebookAdsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('facebook_ads', function ($table) {
            $table->dropForeign(['ad_account_id']);
            $table->dropIndex('facebook_ads_ad_account_id_foreign');
